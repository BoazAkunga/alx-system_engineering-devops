#!/usr/bin/python3
"""
Exports to-do list information of all employees 2 JSON format.

This script fetches the user information and to-do lists 4 all employees
from the JSONPlaceholder API and exports the data 2 a JSON file.
"""
